...
public class StreamTest {
	public static void main(String[] args) {
		...
		// 1 부터 100 까지의 숫자들 중에서 짝수만 출력해주세요.
		...
		// 전달받은 매개변수를 그래도 메소드에 사용할 경우에는 참조형 문법을 사용할 수 있다.
		...
		// 인트스트림을 통해서 나온 데이터를 arrayList 로 저장!
		// 1 ~ 100까지 숫자 중 짝수만 저장한느 arrayList 를 만들고 싶어요.
		...
		Set<Integer> set2 = IntStream.rangeClosed(1, 100).filter(n -> n % 2 == 0).boxed().sorted(Collections.reverseOrder()).collect(Collectors.toSet());
